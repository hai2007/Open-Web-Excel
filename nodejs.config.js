...
let banner = function (pkg) {
    return `/*!
* Open Web Excel - ${pkg.description}
* ${pkg.repository.url}
*
* author ${pkg.author}
*
...
module.exports = {
    ...
    task: {
        ...
        init(hai2007_nodejs, pkg) {
            ...
            printFileSize(1, './dist/open-web-excel.js');
            printFileSize(2, './dist/open-web-excel.min.js');
        ...
        babel(hai2007_nodejs, pkg) {
            ...
            hai2007_nodejs.log("\n[2]babel转义:./dist/module.new.js → ./dist/open-web-excel.js\n");

            babel.transformFile("./dist/module.new.js", {}, function (err, result) {
                if (!err) {
                    fs.writeFileSync("./dist/open-web-excel.js", banner(pkg));
                    fs.appendFileSync("./dist/open-web-excel.js", result.code);
        ...
        uglifyjs(hai2007_nodejs, pkg) {
            ...
            hai2007_nodejs.log("\n[3]压缩代码:./dist/open-web-excel.js → ./dist/open-web-excel.min.js\n");

            cp.exec("uglifyjs ./dist/open-web-excel.js -m -o ./dist/uglifyjs.new.js", function (error) {
                if (error) {
                    console.log(error);
                } else {

                    fs.writeFileSync("./dist/open-web-excel.min.js", banner(pkg));
                    fs.appendFileSync("./dist/open-web-excel.min.js", fs.readFileSync("./dist/uglifyjs.new.js"));
